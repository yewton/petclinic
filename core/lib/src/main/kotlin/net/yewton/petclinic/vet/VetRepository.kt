...
// TODO(arch-split): このリポジトリには Coroutine + jOOQ / Reactor + jOOQ / Coroutine + Spring R2DBC /
//                   Reactor + Spring R2DBC の4バリアントが混在している。本来はアーキテクチャごとに
//                   別モジュールへ分離するべきだが、HTMX / プレーンHTML 分割のスコープ外として
//                   現状を維持し、ここに記録しておく。
@Component
class VetRepository(
