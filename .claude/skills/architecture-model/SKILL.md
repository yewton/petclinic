...
description: PetClinic の container 構成、外部システム、core のドメイン component を変更するときに LikeC4 アーキテクチャモデルを更新する手順。
---
...
- `architecture/views/supplementary.c4`: observability パイプライン、並行実装の correspondence、composite build 依存
